        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <TrendingUp className="text-gold-500 h-8 w-8" />
              <span className="font-playfair font-bold text-xl">RegulaPyme Consulting</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              ...
              <div className="flex items-center">
                ...
                <span>contacto@regulapymeconsulting.cl</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 RegulaPyme Consulting. Todos los derechos reservados.
            </p>
